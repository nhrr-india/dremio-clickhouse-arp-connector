...
3. Take the ClickHouse JDBC driver from (https://github.com/nhrr-india/clickhouse-jdbc) and put in in the \dremio\jars\3rdparty folder
4. Take the ClickHouse JDBC driver from (https://github.com/nhrr-india/clickhouse4j) and put in in the \dremio\jars\3rdparty folder
5. Take the ClickHouse JDBC driver from (https://github.com/nhrr-india/ClickHouse-Native-JDBC) and put in in the \dremio\jars\3rdparty folder
6. Restart Dremio
